          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="my-12 border-t-2 border-primary/20 pt-12">
                <div className="text-center mb-8">
                  <h2 className="text-3xl font-bold mb-3">Script Writers</h2>
                  <p className="text-muted-foreground text-lg">
                    Write viral storytelling scripts without video editing
                  </p>
                </div>

                {/* Script Writer Compensation Structure */}
                <Card className="p-8 mb-8 bg-gradient-to-br from-secondary/5 to-accent/5" id="scriptwriter-section">
                  <div className="flex items-center gap-3 mb-6">
                    <DollarSign className="w-8 h-8 text-secondary" />
                    <h3 className="text-2xl font-bold">Script Writer Compensation</h3>
                  </div>
                  ...
                  <div className="space-y-6">
                    <div className="bg-background/80 backdrop-blur p-6 rounded-lg">
                      ...
                      <div className="grid md:grid-cols-2 gap-4">
                        <div className="border border-border rounded-lg p-4">
                          ...
                          <p className="text-sm text-muted-foreground">For script writers with monthly score above 50</p>
                        </div>
                        <div className="border border-border rounded-lg p-4">
                          <h5 className="font-semibold mb-2">Sales Commission</h5>
                          <p className="text-2xl font-bold text-accent mb-2">10%</p>
                          <p className="text-sm text-muted-foreground">Per sale generated by videos using your scripts</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-background/80 backdrop-blur p-6 rounded-lg">
                      ...
                      <p className="text-lg mb-2">
                        Script Writers monthly income typically ranges from
                      </p>
                      <p className="text-3xl font-bold bg-gradient-to-r from-secondary to-accent bg-clip-text text-transparent">
                        $1,000 - $50,000 USD
                      </p>
                      <p className="text-muted-foreground mt-2">Depending on script performance and quality</p>
                    </div>
                  </div>
                </Card>
